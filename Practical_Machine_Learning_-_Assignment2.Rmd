...
Generating the confusion matrix and statistics shows that our random forest  works well to predict accelerometer measurements. The accuracy comes to be almost one, with only one value predicted incorrectly on this test data set. 
```{r}
